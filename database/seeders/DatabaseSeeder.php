...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Idempotente: eseguibile anche da solo su un ambiente che ha già
        // questi dati (es. produzione), senza incorrere negli errori di
        // chiave duplicata dei blocchi non idempotenti sopra.
        $this->call(AcmeDemoCompanySeeder::class);
    }
}
